...
def page_config_main(varAppName: str, varAppIcon, varAppLayout, varInitialSidebar, varPageTitle, varPageSubtitle, varPageIcon, varPageDescription, varOverviewHeader):     
    st.set_page_config(
          page_title=varAppName,
          page_icon=varAppIcon,
          layout=varAppLayout,
          initial_sidebar_state=varInitialSidebar
     )

    set_title(
          varTitle=varPageTitle,
          varSubtitle=varPageSubtitle
     )
    
    set_page_overview(
         varHeader=varOverviewHeader,
         varText=f"**{varPageTitle}** {varPageDescription.lower()}"
    )
